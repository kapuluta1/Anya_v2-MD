...
module.exports = {
     ...
     */
    ownername: process.env.OWNER_NUMBER || process.env.Owner_Name || "𝐑𝐢𝐜𝐡𝐚𝐫𝐝",
    ownernumber: process.env.Owner_Number || "255789622341",
    instagramId: process.env.Insta || "3.69_pika",

    /**
     * other details and parameters
     */
    author: process.env.Author || "𝐆𝐎𝐋𝐃𝐄𝐍 𝐅𝐀𝐌𝐈𝐋𝐘",
    ...
    sessionId: process.env.SESSION_ID |  BIlh8Ko_A_N_Y_A_V_2_PSq5navQYvna5   "YOUR_SESSION_ID",
